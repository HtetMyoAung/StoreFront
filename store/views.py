...
class ProductList(APIView):
    ...
    def get(self, request):
        ...
        # serialize the queryset and return the serialized data in the response
...
class CollectionList(APIView):
    def get(self, request):
        # get all collections from the database, annotate them with the count of products in each collection, serialize them, and return them in the response
